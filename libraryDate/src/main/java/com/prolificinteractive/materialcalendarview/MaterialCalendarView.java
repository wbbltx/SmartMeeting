...
public class MaterialCalendarView extends ViewGroup {
     ...
     * 显示不启用日期的默认标志。目前只显示{@链接# show_decorated_disabled }
     */
    ...
    public void setSelectionColor(int color, CalendarDay date) {
        ...
        accentColor = color;
        adapter.setSelectionColor(color, date);
        invalidate();
    }
