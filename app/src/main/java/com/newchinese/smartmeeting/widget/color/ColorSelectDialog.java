...
public class ColorSelectDialog {
    ...
    public ColorSelectDialog(Context context) {
        ...
        builder.setPositiveButton(App.getContext().getString(R.string.btn_confirm1), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(App.getContext().getString(R.string.btn_cancel), null);
