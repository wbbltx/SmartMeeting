...
public class GuiDangInfoWindow extends PopupWindow implements View.OnClickListener {
    ...
    public GuiDangInfoWindow(Context context, PopWindowListener popWindowListener) {
        super(context);
...
//        this.setFocusable(true);
        ...
        setHintText("归档",context.getString(R.string.btn_cancel),context.getString(R.string.guidang_hint));
    }
